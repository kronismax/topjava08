...
3. Сделать тесты всех реализаций (`jdbc, jpa, datajpa`) через наследование (без дублирования), общее из `MealServiceTest` и `UserServiceTest` вынеси в базовый класс.
